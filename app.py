...
color_array = np.where(display_data.rsi > 70, 'red', np.where(display_data.rsi < 30, 'green', '#0095e8'))

fig2.add_trace(go.Scatter(x=display_data.Date, y=display_data.rsi, name="RSI", line=dict(color=color_array, width=3)))
